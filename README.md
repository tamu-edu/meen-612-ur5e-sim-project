...
# Finally, install drake and matplotlib

pip install drake matplotlib
```

you are now ready to run the code in this repo!

### Running the Sim

```
# be sure you're already sourced the venv if starting a new session
